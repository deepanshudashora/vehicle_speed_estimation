...
labelsPath = "/home/deepanshu/Desktop/car_speed_project/yolov4_vehicle_detection-288.names"
...
weightsPath = "/home/deepanshu/Desktop/car_speed_project/yolov4_vehicle_detection-288.weights"
configPath = "/home/deepanshu/Desktop/car_speed_project/yolov4_vehicle_detection-288.cfg"
...
vs = cv2.VideoCapture("/home/deepanshu/Desktop/car_speed_project/9convertcomCarTraffic.mp4")
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter("video.mp4", fourcc, 30, (W, H), True)
    ...
    if totalFrames % 10 == 0:
        ...
        blob = cv2.dnn.blobFromImage(frame, 1/255, (288,288), swapRB=True, crop=False)
        net.setInput(blob)
