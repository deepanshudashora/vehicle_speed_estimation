...
ap.add_argument("-i", "--record2.mp4", required=True,
	help="path to input video")
ap.add_argument("-o", "--output.mp4", required=True,
...
vs = cv2.VideoCapture("test_20.mp4")
...
while True:
    ...
    if "/home/deepanshu/Desktop/record9.mp4" is not None and writer is None:
        fourcc = cv2.VideoWriter_fourcc(*"MJPG")
        writer = cv2.VideoWriter("/home/deepanshu/Desktop/record3.mp4", fourcc, 30, (W, H), True)
